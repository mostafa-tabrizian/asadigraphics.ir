            ...
            <div className='text-gray-700'>
               <Link href='/'>
                  <div className='relative flex items-center'>
                     <span className='flex cursor-pointer items-center gap-x-2 py-2 font-bold hover:text-orange-600 md:py-1'>
                        <svg
                        ...
                        <span className='whitespace-nowrap text-base text-inherit'>صفحه اصلی</span>
                     </span>
                  </div>
               </Link>
            </div>
            ...
            <div className='text-gray-700'>
               ...
               >
                  <span className='flex cursor-pointer items-center gap-x-2 py-1 font-bold hover:text-orange-600 '>
                     ...
                     <span className='whitespace-nowrap text-base text-inherit'>دسته بندی ها</span>
                     <svg
                        stroke='currentColor'
                        fill='none'
                        strokeWidth='0'
            ...
            <div className='text-gray-700'>
               ...
               >
                  <span className='flex cursor-pointer items-center gap-x-2 py-1 font-bold hover:text-orange-600'>
                     ...
                     <span className='whitespace-nowrap text-base text-inherit'>ارتباط با ما</span>
                     <svg
                        stroke='currentColor'
                        fill='none'
                        strokeWidth='0'
               ...
               <a id='about_us' href='#about-us'>
                  <div className='relative flex items-center'>
                     <span className='flex cursor-pointer items-center gap-x-2 py-2 font-bold hover:text-orange-600 md:py-1'>
                        ...
                        <span className='whitespace-nowrap text-base text-inherit'>درباره ما</span>
                     </span>
                  </div>
               </a>
            </div>
